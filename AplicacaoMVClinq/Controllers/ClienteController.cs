...
namespace AplicacaoMVClinq.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public IActionResult GetCliente()
        {
            ...
            Cliente c4 = new Cliente(1, "Alice", "alice@example.com", "1234-5678", new DateOnly(2000, 6, 1));
            Cliente c5 = new Cliente(1, "Alice", "alice@example.com", "1234-5678", new DateOnly(2000, 6, 1));
